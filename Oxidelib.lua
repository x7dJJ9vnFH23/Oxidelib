...
function TagSystem:OnUsersUpdated(fn) return fn end
function TagSystem:RemoveListener(fn) return false end
...
function Library:CreateWindow(opts)
    ...
    local adminListener = nil
    local setAdminVisible = nil
